...
Theorem t_update_neq : forall (A : Type) (m : total_map A) x1 x2 v,
  ...
  (x1 !-> v ; m) x2 = m x2.
Proof.
  (* TODO: Tentei aplicar destruct eqb_spec, e tive mensagem dizendo
           que espera s1, s2. Então temos que passar tais valores.*)
  intros. unfold t_update. destruct (eqb_spec x1 x2).
  - (* Não tem como v = m x2 *) exfalso. apply H. apply e.
  - (* Dois lados iguais     *) reflexivity.
Qed.  
(** [] *)
...
Compute partial_map.
Compute partial_map bool.
Compute partial_map (option nat).
...
Compute examplepmap "Turing".
Compute examplepmap "Charles".

(* ===========================================================================
   bs_a4.v -- minimal three-way comparison on length alone
   ---------------------------------------------------------------------------
   Role       : Baby Step 2 - isolates manual / Trocq-iso / parametric strategies
   Depends on : self-contained
   Provenance : authored for this study
   Measured   : 14 proofs, 62 tactic steps, 5 [Trocq Use]

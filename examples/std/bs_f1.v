(* ===========================================================================
   bs_f1.v -- Fermat degree 3 mod 9: infinite-to-finite space reduction
   ---------------------------------------------------------------------------
   Role       : Auxiliary - a transfer whose value is decidability, not effort saving
   Depends on : MathComp (all_boot, all_algebra)
   Provenance : authored for this study
   Measured   : 9 proofs, 42 tactic steps, 3 [Trocq Use]

   Formerly bs_a5.v; renamed in commit 0141a30.  Included to show the cost
   model covers transfers undertaken for a qualitatively different reason.

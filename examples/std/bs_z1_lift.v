(* ===========================================================================
   bs_z1_lift.v -- divergence test: where a copy-pasted proof fails outright
   ---------------------------------------------------------------------------
   Role       : Baby Step 2 - the sharpest REGIME B exhibit
   Depends on : bs_z1
   Provenance : authored for this study
   Measured   : 14 proofs, 59 tactic steps, 7 [Trocq Use]

   Contains a DELIBERATE failure at the [Fail apply add_zero_r] goal: the
   Addable class provides only right identity while peval associates
   right-to-left, so the renamed proof is genuinely stuck.  Unlike bs_a2.v,
   no hand repair rescues it.  _count_steps.py flags this proof rather
   than counting it as completed work.

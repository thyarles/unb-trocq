(* ===========================================================================
   bs_p4.v -- manual proof transfer via explicit bijections
   ---------------------------------------------------------------------------
   Role       : Baby Step 1 - the bridge-based manual baseline (REGIME B)
   Depends on : bs_p1, bs_p2
   Provenance : authored for this study
   Measured   : 5 proofs, 26 tactic steps, 0 [Trocq Use]

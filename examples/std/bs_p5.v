(* ===========================================================================
   bs_p5.v -- Trocq proof transfer for length and append
   ---------------------------------------------------------------------------
   Role       : Baby Step 1 - the Trocq baseline; introduces the monomorphic-alias tax
   Depends on : bs_p1, bs_p2
   Provenance : authored for this study
   Measured   : 10 proofs, 44 tactic steps, 5 [Trocq Use]
